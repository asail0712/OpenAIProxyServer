...
namespace OpenAIProxyService.Controllers
{
    ...
    {
        // authorization
        public const int InvalidCredentials             = 100001;
        ...
        protected override CustomErrorResponse FilterOtherError(CustomException customException)
        {
            ...
            switch (customException)
            {
                case InvalidCredentialsException invalidCredentialsException:
                    ...
                    response.ErrorCode  = ProxyServiceErrorCode.InvalidCredentials;
                    response.Message    = "invalid Credentials";
                    response.Detail     = invalidCredentialsException.Message;
                    return response;
